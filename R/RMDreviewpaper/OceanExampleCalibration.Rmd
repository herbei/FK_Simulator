...
```{r calseq}
calHetseq <- MCMCmetrop1R(lpost.invert, XF=Xfield[,1:2], yF=YfieldnoiseN, GP=seqGhet, logfun=TRUE, theta.init=c(0.5,0.5,1),                     burnin=1000, mcmc=2e4, V=Vrw)
```
